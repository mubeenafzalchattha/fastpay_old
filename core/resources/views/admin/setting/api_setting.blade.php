                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <div class="form-group">
                                        <small>@lang('Set up cron job for update fiat price rate :')</small>
                                        <small class="text--primary">{{ route('cron.fiat.rate') }}</small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <div class="form-group">
                                        <small>@lang('Set up cron job for update crypto price rate :')</small>
                                        <small class="text--primary">{{ route('cron.crypto.rate') }}</small>
                                    </div>
                                </div>
                            </div>
