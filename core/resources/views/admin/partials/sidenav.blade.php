    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.ad*',3)}}">
                        <i class="menu-icon la la-list"></i>
                        <span class="menu-title">@lang('Manage Ads') </span>
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.ad*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.ad.limit.index')}}">
                                <a href="{{route('admin.ad.limit.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Limit')</span>
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.trade*',3)}}">
                        <i class="menu-icon las la-exchange-alt"></i>
                        <span class="menu-title">@lang('Manage Trades') </span>
                        @if($reportedTrade > 0 )
                            <span class="menu-badge pill bg--danger ms-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.trade*',2)}} ">
                        <ul>


                            <li class="sidebar-menu-item {{menuActive('admin.trade.running')}}">
                                <a href="{{route('admin.trade.running')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Running')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.trade.reported')}}">
                                <a href="{{route('admin.trade.reported')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.trade.completed')}}">
                                <a href="{{route('admin.trade.completed')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Completed')</span>
                                </a>
                            </li>

                              <li class="sidebar-menu-item {{menuActive('admin.trade.index')}}">
                                <a href="{{route('admin.trade.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.crypto*')}}">
                    <a href="{{route('admin.crypto.index')}}" class="nav-link ">
                        <i class="menu-icon lab la-bitcoin"></i>
                        <span class="menu-title">@lang('Crypto Currencies')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.fiat.currency*')}}">
                    <a href="{{route('admin.fiat.currency.index')}}" class="nav-link ">
                        <i class="menu-icon las la-coins"></i>
                        <span class="menu-title">@lang('Fiat Currencies')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.fiat.gateway*')}}">
                    <a href="{{route('admin.fiat.gateway.index')}}" class="nav-link ">
                        <i class="menu-icon las la-wallet"></i>
                        <span class="menu-title">@lang('Fiat Gateways')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.window*')}}">
                    <a href="{{route('admin.window.index')}}" class="nav-link ">
                        <i class="menu-icon las la-stopwatch"></i>
                        <span class="menu-title">@lang('Payment Windows')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.api.index')}}">
