                ...
                <div class="card custom--card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('ticket.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div>
                                <div class="text-end">
                                    <button type="button" class="btn btn--base btn-sm mt-4 addFile">
                                ...
                                <div class="file-upload">
                                    ...
                                    <input type="file" name="attachments[]" id="inputAttachments" class="form-control custom-input-field mb-2" />
